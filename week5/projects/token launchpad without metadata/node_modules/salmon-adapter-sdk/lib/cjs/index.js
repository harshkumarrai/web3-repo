...
var extension_1 = __importDefault(require("./adapters/extension"));
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (typeof this._provider === 'string') {
                            this._adapterInstance = new web_1.default(this._provider, this._network);
                        }
                        else {
                            this._adapterInstance = new extension_1.default(this._provider, this._network);
                        }
