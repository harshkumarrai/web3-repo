...
var WalletProvider_1 = __importDefault(require("./WalletProvider"));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, bs58_1.default.decode(signedTransaction)];
                }
            });
        });
    };
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._sendRequest('signAllTransactionsV2', {
                                transactions: transactions.map(function (transaction) { return bs58_1.default.encode(transaction); })
                            })];
                    case 1:
                        signedTransactions = (_a.sent()).transactions;
                        return [2 /*return*/, signedTransactions.map(function (transaction) { return bs58_1.default.decode(transaction); })];
                }
            });
        });
    };
