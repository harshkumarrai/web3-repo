        ...
        if (cert.type === CertificateType.STAKE_REGISTRATION) {
            ...
            switch (cert.dRep.type) {
                ...
                case CardanoDRepType.SCRIPT_HASH:
                    targetDRep = CardanoWasm.DRep.new_script_hash(CardanoWasm.ScriptHash.from_hex(cert.dRep.scriptHash));
                    break;
            }
            if (targetDRep) {
                preparedCertificates.add(CardanoWasm.Certificate.new_vote_delegation(CardanoWasm.VoteDelegation.new(stakeCred, targetDRep)));
            }
        }
        else {
...
export const setMaxOutput = (txBuilder, maxOutput, changeOutput) => {
    var _a, _b, _c, _d, _e;
    const maxOutputAsset = (_b = (_a = maxOutput.assets[0]) === null || _a === void 0 ? void 0 : _a.unit) !== null && _b !== void 0 ? _b : 'lovelace';
    ...
    if (maxOutputAsset === 'lovelace') {
        ...
        if (changeOutput) {
            ...
            const previousMaxOutputCost = getOutputCost(txBuilder, maxOutput, (_c = maxOutput.address) !== null && _c !== void 0 ? _c : changeOutput.output.address().to_bech32());
        ...
        if (changeOutput) {
            ...
            newMaxAmount = bigNumFromStr((_e = (_d = changeOutputAssets.find(a => a.unit === maxOutputAsset)) === null || _d === void 0 ? void 0 : _d.quantity) !== null && _e !== void 0 ? _e : '0');
