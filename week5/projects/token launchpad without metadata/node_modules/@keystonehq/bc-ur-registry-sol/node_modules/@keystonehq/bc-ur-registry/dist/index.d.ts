...
declare const URlib: {
    ...
    CryptoPSBTExtend: typeof CryptoPSBTExtend;
...
export { URRegistryDecoder, Bytes, CryptoAccount, CryptoHDKey, CryptoMultiAccounts, CryptoKeypath, CryptoCoinInfo, CryptoCoinInfoType, CryptoCoinInfoNetwork, CryptoECKey, CryptoOutput, CryptoPSBT, CryptoPSBTExtend, MultiKey, ScriptExpressions, PathComponent, extend, Buffer };
export * from './errors';
export * from './Decoder';
export * from './lib';
