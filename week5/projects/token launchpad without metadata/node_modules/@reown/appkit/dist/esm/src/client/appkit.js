...
import { ApiController, ConnectionController, ConnectorController, ConstantsUtil as CoreConstantsUtil, EventsController } from '@reown/appkit-controllers';
...
export class AppKit extends AppKitBaseClient {
    ...
    setupAuthConnectorListeners(provider) {
        ...
        provider.onConnect(async (user) => {
            ...
            const preferredAccountType = OptionsController.state.defaultAccountTypes[namespace];
            const isPreferredAccountTypeSame = Boolean(user.preferredAccountType) &&
            ...
            this.setPreferredAccountType(user.preferredAccountType || preferredAccountType, namespace);
