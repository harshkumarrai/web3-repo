...
const rpcErrors = {
   ...
   * @returns An instance of the {@link JsonRpcError} class.
   */
  invalidInput: arg => getJsonRpcError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.rpc.invalidInput, arg),
  /**
   ...
   * @returns An instance of the {@link JsonRpcError} class.
   */
  resourceNotFound: arg => getJsonRpcError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.rpc.resourceNotFound, arg),
  /**
   ...
   * @returns An instance of the {@link JsonRpcError} class.
   */
  resourceUnavailable: arg => getJsonRpcError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.rpc.resourceUnavailable, arg),
  /**
   ...
   * @returns An instance of the {@link JsonRpcError} class.
   */
  transactionRejected: arg => getJsonRpcError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.rpc.transactionRejected, arg),
  /**
   ...
   * @returns An instance of the {@link JsonRpcError} class.
   */
  methodNotSupported: arg => getJsonRpcError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.rpc.methodNotSupported, arg),
  /**
   ...
   * @returns An instance of the {@link JsonRpcError} class.
   */
  limitExceeded: arg => getJsonRpcError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.rpc.limitExceeded, arg)
};
const providerErrors = {
  ...
  userRejectedRequest: arg => {
    return getEthProviderError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.provider.userRejectedRequest, arg);
  },
  /**
   ...
   */
  unauthorized: arg => {
    return getEthProviderError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.provider.unauthorized, arg);
  },
  /**
  ...
  unsupportedMethod: arg => {
    return getEthProviderError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.provider.unsupportedMethod, arg);
  },
  /**
   ...
   */
  disconnected: arg => {
    return getEthProviderError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.provider.disconnected, arg);
  },
  /**
  ...
  chainDisconnected: arg => {
    return getEthProviderError(_error_constants__WEBPACK_IMPORTED_MODULE_0__/* .errorCodes */ .f.provider.chainDisconnected, arg);
  },
  /**
  ...
  custom: opts => {
    ...
    return new _errorClasses__WEBPACK_IMPORTED_MODULE_1__/* .EthereumProviderError */ .B(code, message, data);
  }
};
...
/* harmony export */   B: () => (/* reexport safe */ _errorClasses__WEBPACK_IMPORTED_MODULE_1__.B),
/* harmony export */   DW: () => (/* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_3__.DW),
/* harmony export */   Gm: () => (/* reexport safe */ _errorClasses__WEBPACK_IMPORTED_MODULE_1__.G),
...
/* harmony export */   fv: () => (/* reexport safe */ _error_constants__WEBPACK_IMPORTED_MODULE_0__.f),
/* harmony export */   rK: () => (/* reexport safe */ _errors__WEBPACK_IMPORTED_MODULE_2__.r),
/* harmony export */   zI: () => (/* reexport safe */ _error_constants__WEBPACK_IMPORTED_MODULE_0__.z)
/* harmony export */ });
/* harmony import */ var _error_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(537);
/* harmony import */ var _errorClasses__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(869);
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(832);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(330);
...
/* harmony import */ var _error_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(537);
...
/* harmony import */ var _safeEventEmitter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(573);
/* harmony import */ var _serializableError__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(680);
  ...
  return (req, res, next, end) => {
    try {
      ...
      if (typeof req.method !== "string" || !req.method) {
        res.error = new _serializableError__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A({
          code: -32603,
...
function createStreamMiddleware() {
  ...
  const events = new _safeEventEmitter__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A();
...
/* harmony import */ var _errors_errors__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(832);
/* harmony import */ var _errors_utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(330);
/* harmony import */ var _safeEventEmitter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(573);
/* harmony import */ var _serializableError__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(680);
 ...
 */
class JRPCEngine extends _safeEventEmitter__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A {
  constructor() {
    super();
    ...
    return new Promise(resolve => {
      const end = err => {
        ...
        if (error) {
          ...
          res.error = (0,_errors_utils__WEBPACK_IMPORTED_MODULE_4__/* .serializeError */ .P5)(error, {
            shouldIncludeStack: true,
            fallbackError: {
        ...
        if (res.error) {
          ...
          if (returnHandler) {
            if (typeof returnHandler !== "function") {
              end(new _serializableError__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A({
                code: -32603,
  ...
  static _checkForCompletion(_req, res, isComplete) {
    if (!("result" in res) && !("error" in res)) {
      throw new _serializableError__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A({
        code: -32603,
  ...
  async _handle(callerReq, cb) {
    if (!callerReq || Array.isArray(callerReq) || typeof callerReq !== "object") {
      const error = new _serializableError__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A({
        code: -32603,
...
function providerFromEngine(engine) {
  const provider = new _safeEventEmitter__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .A();
  ...
  provider.sendAsync = async req => {
    ...
    if (res.error) {
      ...
      const err = (0,_errors_utils__WEBPACK_IMPORTED_MODULE_4__/* .serializeError */ .P5)(res.error, {
        fallbackError: {
      ...
      throw _errors_errors__WEBPACK_IMPORTED_MODULE_3__/* .rpcErrors */ .r.internal(err);
    }
    return res.result;
  };
...
var src_substream = __webpack_require__(577);
...
class ObjectMultiplex extends external_readable_stream_.Duplex {
  ...
  createStream(name) {
    ...
    // create substream
    const substream = new src_substream/* default */.A({
      parent: this,
      name
    });
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ PostMessageStream)
/* harmony export */ });
/* harmony import */ var _basePostMessageStream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(681);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ SerializableError)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(990);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var fast_safe_stringify__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(662);
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   A: () => (/* binding */ Substream)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(990);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var readable_stream__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(741);
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   BasePostMessageStream: () => (/* reexport safe */ _basePostMessageStream__WEBPACK_IMPORTED_MODULE_0__.A),
...
/* harmony export */   PostMessageStream: () => (/* reexport safe */ _postMessageStream__WEBPACK_IMPORTED_MODULE_6__.A),
/* harmony export */   SafeEventEmitter: () => (/* reexport safe */ _safeEventEmitter__WEBPACK_IMPORTED_MODULE_7__.A),
/* harmony export */   SerializableError: () => (/* reexport safe */ _serializableError__WEBPACK_IMPORTED_MODULE_8__.A),
/* harmony export */   Substream: () => (/* reexport safe */ _substream__WEBPACK_IMPORTED_MODULE_9__.A),
...
/* harmony export */ });
/* harmony import */ var _basePostMessageStream__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(681);
/* harmony import */ var _errors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(835);
/* harmony import */ var _interfaces__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(927);
...
/* harmony import */ var _jrpc__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(786);
/* harmony import */ var _jrpcEngine__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(548);
/* harmony import */ var _mux__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(476);
/* harmony import */ var _postMessageStream__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(770);
/* harmony import */ var _safeEventEmitter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(573);
/* harmony import */ var _serializableError__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(680);
/* harmony import */ var _substream__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(577);
