...
class TorusCommunicationProvider extends baseProvider {
  constructor(connectionStream, _ref) {
    ...
    this._state = objectSpread2_default()({}, TorusCommunicationProvider._defaultState);
...
class Torus {
  ...
  async init() {
    ...
    loglevel.info(`Solana Embed Version :${package_namespaceObject.rE}`);
    this.torusUrl = torusUrl;
  ...
  async _setupWeb3(providerParams) {
    ...
    await Promise.all([inPageProvider._initializeState(), communicationProvider._initializeState(objectSpread2_default()(objectSpread2_default()({}, providerParams), {}, {
