...
class ParticleAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
    constructor(config = {}) {
        ...
        this._wallet = null;
        this._config = {
            config: Object.assign(Object.assign({ projectId: '', clientKey: '', appId: '' }, config.config), { chainId: (_b = (_a = config.config) === null || _a === void 0 ? void 0 : _a.chainId) !== null && _b !== void 0 ? _b : 101, chainName: (_d = (_c = config.config) === null || _c === void 0 ? void 0 : _c.chainName) !== null && _d !== void 0 ? _d : 'solana' }),
            login: config.login,
        };
    }
    get particle() {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let WalletClass;
                try {
                    ({ ParticleNetwork: ParticleClass, SolanaWallet: WalletClass } = yield Promise.resolve().then(() => __importStar(require('@particle-network/solana-wallet'))));
                }
                catch (error) {
                ...
                try {
                    ...
                    if (!particle.auth.isLogin()) {
                        yield particle.auth.login(this._config.login);
                    }
                }
                catch (error) {
