...
import { CompilableTransactionMessage, TransactionMessage, TransactionMessageWithFeePayer } from '@solana/transaction-messages';
...
type ComputeUnitEstimateForTransactionMessageFunction = (transactionMessage: CompilableTransactionMessage | (TransactionMessage & TransactionMessageWithFeePayer), config?: Omit<Parameters<typeof getComputeUnitEstimateForTransactionMessage_INTERNAL_ONLY_DO_NOT_EXPORT>[0], 'rpc' | 'transactionMessage'>) => Promise<number>;
/**
