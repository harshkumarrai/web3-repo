...
export type UpdateEvmSmartAccountResult = NonNullable<Awaited<ReturnType<typeof updateEvmSmartAccount>>>;
export type PrepareUserOperationResult = NonNullable<Awaited<ReturnType<typeof prepareUserOperation>>>;
export type PrepareAndSendUserOperationResult = NonNullable<Awaited<ReturnType<typeof prepareAndSendUserOperation>>>;
...
export type CreateSpendPermissionResult = NonNullable<Awaited<ReturnType<typeof createSpendPermission>>>;
export type ListSpendPermissionsResult = NonNullable<Awaited<ReturnType<typeof listSpendPermissions>>>;
export type RevokeSpendPermissionResult = NonNullable<Awaited<ReturnType<typeof revokeSpendPermission>>>;
export {};
