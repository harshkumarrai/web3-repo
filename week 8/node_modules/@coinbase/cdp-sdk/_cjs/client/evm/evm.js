...
const listSpendPermissions_js_1 = require("../../actions/evm/listSpendPermissions.js");
...
const constants_js_2 = require("../../spend-permissions/constants.js");
...
class EvmClient {
    ...
    async listSpendPermissions(options) {
        ...
        return (0, listSpendPermissions_js_1.listSpendPermissions)(index_js_1.CdpOpenApiClient, options);
    }
    /**
    ...
    async _createSmartAccountInternal(options) {
        ...
        if (options.enableSpendPermissions) {
            owners.push(constants_js_2.SPEND_PERMISSION_MANAGER_ADDRESS);
        }
    ...
    async _getSmartAccountInternal(options) {
        ...
        if (!openApiSmartAccount.owners.includes(options.owner.address)) {
            throw new errors_js_1.UserInputValidationError(`Owner mismatch: The provided owner address is not an owner of the smart account. Please use a valid owner for this smart account.
