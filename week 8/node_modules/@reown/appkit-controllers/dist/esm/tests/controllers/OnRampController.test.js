...
import { AccountController, ApiController, BlockchainApiController, OnRampController, OptionsController } from '../../exports/index.js';
...
describe('OnRampController', () => {
    ...
    it('should set providers if valid names are provided', () => {
        ...
        OnRampController.setOnrampProviders(validProviderNames);
    ...
    it('should set an empty array if the input is not an array of strings', () => {
        OnRampController.setOnrampProviders(null);
        expect(OnRampController.state.providers).toEqual([]);
        OnRampController.resetState();
        OnRampController.setOnrampProviders({ provider: 'coinbase' });
        expect(OnRampController.state.providers).toEqual([]);
        OnRampController.resetState();
        OnRampController.setOnrampProviders(['coinbase', 123]);
        expect(OnRampController.state.providers).toEqual([]);
    });
    it('should properly configure meld url', () => {
        ...
        OnRampController.resetState();
        const meldProvider = ONRAMP_PROVIDERS[1];
