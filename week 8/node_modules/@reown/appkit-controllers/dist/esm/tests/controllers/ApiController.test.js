...
import { ApiController, AssetController, ChainController, ConnectorController, CoreHelperUtil, OptionsController } from '../../exports/index.js';
...
describe('ApiController', () => {
    ...
    it('should filter wallets by provided namespaces', () => {
        const mockWallets = [
            { id: '1', name: 'Wallet1', chains: ['eip155:1'] },
            { id: '2', name: 'Wallet2', chains: ['solana:1'] },
            { id: '3', name: 'Wallet3', chains: ['eip155:1', 'solana:1'] }
        ];
