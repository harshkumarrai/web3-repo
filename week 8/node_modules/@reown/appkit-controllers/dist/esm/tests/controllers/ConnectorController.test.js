...
describe('ConnectorController', () => {
    ...
    it('should call mobile wallet util when selecting wallet is Phantom ', () => {
        ...
        expect(handleMobileDeeplinkRedirectSpy).toHaveBeenCalledWith(mockConnector.id, ConstantsUtil.CHAIN.EVM);
    });
    it('should call mobile wallet util when selecting wallet is Coinbase only on Solana ', () => {
        ...
        expect(window.location.href).toBe(expectedUrl);
        expect(handleMobileDeeplinkRedirectSpy).toHaveBeenCalledWith(mockConnector.id, ConstantsUtil.CHAIN.SOLANA);
    });
