...
describe('SendApiUtil', () => {
    ...
    describe('mapBalancesToSwapTokens', () => {
        ...
        it('should map balances to swap tokens correctly', () => {
            ...
            const result = SendApiUtil.mapBalancesToSwapTokens(mockBalances);
            expect(result).toEqual([
                {
                    address: '0x123',
                    symbol: 'ETH',
        ...
        it('should use network token address when balance address is undefined', () => {
            ...
            vi.spyOn(ChainController, 'getActiveNetworkTokenAddress').mockReturnValue(mockNetworkTokenAddress);
            const result = SendApiUtil.mapBalancesToSwapTokens(mockBalances);
        ...
        it('should handle undefined balances', () => {
            const result = SendApiUtil.mapBalancesToSwapTokens(undefined);
            expect(result).toEqual([]);
        });
    });
...
//# sourceMappingURL=SendApiUtil.test.js.map