...
describe('StorageUtil', () => {
    ...
    describe('getWalletConnectDeepLink', () => {
        it('should get WalletConnect deep link from localStorage', () => {
            const deepLink = { href: 'https://example.com', name: 'Example Wallet' };
            SafeLocalStorage.setItem(SafeLocalStorageKeys.DEEPLINK_CHOICE, JSON.stringify({ href: deepLink.href, name: deepLink.name }));
    ...
    describe('deleteWalletConnectDeepLink', () => {
        it('should delete WalletConnect deep link from localStorage', () => {
            SafeLocalStorage.setItem(SafeLocalStorageKeys.DEEPLINK_CHOICE, JSON.stringify({ href: 'https://example.com', name: 'Example' }));
    ...
    describe('getConnections', () => {
        it('should set and get connections', () => {
            StorageUtil.setConnections([{ accounts: [{ address: 'address1' }], connectorId: 'connector1' }], 'eip155');
