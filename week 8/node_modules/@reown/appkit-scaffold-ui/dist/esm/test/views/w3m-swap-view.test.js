...
describe('W3mSwapView', () => {
    ...
    it('should call handleChangeAmount with max value when setting max value', async () => {
        ...
        const element = await fixture(html `<w3m-swap-view></w3m-swap-view>`);
        await element.updateComplete;
        const handleChangeAmountSpy = vi.spyOn(element, 'handleChangeAmount');
        element['onSetMaxValue']('sourceToken', '100');
        vitestExpect(handleChangeAmountSpy).toHaveBeenCalledWith('sourceToken', '100.00000000000000000000');
