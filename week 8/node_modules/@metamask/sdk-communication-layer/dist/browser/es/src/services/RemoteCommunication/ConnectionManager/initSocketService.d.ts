 ...
 */
export declare function initSocketService({ communicationLayerPreference, otherPublicKey, reconnect, ecies, communicationServerUrl, instance, }: {
...
//# sourceMappingURL=initSocketService.d.ts.map