...
import { FullySignedTransaction, TransactionFromTransactionMessage } from '@solana/transactions';
 ...
 */
export declare function partiallySignTransactionMessageWithSigners<TTransactionMessage extends BaseTransactionMessage & TransactionMessageWithFeePayer & TransactionMessageWithSigners>(transactionMessage: TTransactionMessage, config?: TransactionPartialSignerConfig): Promise<TransactionFromTransactionMessage<TTransactionMessage>>;
/**
 * Extracts all {@link TransactionSigner | TransactionSigners} inside the provided
 ...
 * @see {@link signAndSendTransactionMessageWithSigners}
 */
export declare function signTransactionMessageWithSigners<TTransactionMessage extends BaseTransactionMessage & TransactionMessageWithFeePayer & TransactionMessageWithSigners>(transactionMessage: TTransactionMessage, config?: TransactionPartialSignerConfig): Promise<FullySignedTransaction & TransactionFromTransactionMessage<TTransactionMessage>>;
/**
 * Extracts all {@link TransactionSigner | TransactionSigners} inside the provided
 ...
 *
 */
export declare function signAndSendTransactionMessageWithSigners<TTransactionMessage extends BaseTransactionMessage & TransactionMessageWithFeePayer & TransactionMessageWithSigners>(transaction: TTransactionMessage, config?: TransactionSendingSignerConfig): Promise<SignatureBytes>;
