...
export declare const ThemeColorScheme: z.ZodMiniUnion<readonly [z.ZodMiniLiteral<"light">, z.ZodMiniLiteral<"dark">, z.ZodMiniLiteral<"light dark">]>;
export type ThemeColorScheme = z.infer<typeof ThemeColorScheme>;
export declare const isThemeColorScheme: (value: unknown) => value is "light" | "dark" | "light dark";
/**
 * Porto theme definition.
 */
export type Theme<ColorScheme extends ThemeColorScheme, SchemeColor = ColorScheme extends 'light dark' ? LightDarkColor : Color> = {
...
type PartialTheme<Th extends Theme<ThemeColorScheme>> = Partial<Omit<Th, 'colorScheme'>> & {
 ...
 */
export type ThemeFragment = PartialTheme<Theme<'light'>> | PartialTheme<Theme<'dark'>> | PartialTheme<Theme<'light dark'>>;
export declare const Color: z.ZodMiniUnion<readonly [z.ZodMiniLiteral<"transparent">, z.ZodMiniString<string>]>;
export declare const LightDarkColor: z.ZodMiniReadonly<z.ZodMiniTuple<readonly [z.ZodMiniUnion<readonly [z.ZodMiniLiteral<"transparent">, z.ZodMiniString<string>]>, z.ZodMiniUnion<readonly [z.ZodMiniLiteral<"transparent">, z.ZodMiniString<string>]>], null>>;
/**
...
export declare const isLightDarkColor: (value: unknown) => value is readonly [string, string];
export {};
