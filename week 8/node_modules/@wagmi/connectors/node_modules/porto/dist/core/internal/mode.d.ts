...
export type ActionsInternal<chains extends readonly [Chains.Chain, ...Chains.Chain[]] = readonly [
    Chains.Chain,
    ...Chains.Chain[]
...
export type Mode = {
    actions: {
        ...
        getAssets: (parameters: RpcRequest.wallet_getAssets.Parameters & {
            /** Internal properties. */
            internal: ActionsInternal;
        ...
        prepareCalls: (parameters: {
            ...
            /** Capabilities. */
            capabilities?: RpcSchema.wallet_prepareCalls.Response['capabilities'] | undefined;
 ...
 * @returns Mode.
 */
export declare function from<const mode extends from.Parameters>(mode: mode | from.Parameters): Assign<Mode, mode>;
 ...
 */
export declare function getAuthorizeCalls(keys: readonly Key.Key[]): readonly Call.Call[];
/**
 *
 * @param parameters
 * @returns
 */
export declare function getAuthorizedExecuteKey(parameters: {
    account: Account.Account;
    calls: readonly Call.Call[];
    permissionsId?: Hex.Hex | null | undefined;
