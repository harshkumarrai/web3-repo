...
export declare const defaultConfig: {
        ...
        fees: import("viem").ChainFees<{
            ...
            readonly transaction: {
                ...
                format: (args: import("viem/chains").CeloRpcTransaction, action?: string | undefined) => ({
                    ...
                    sourceHash?: undefined;
                    gatewayFee?: undefined;
                    gatewayFeeRecipient? /** Address of the account. */: undefined;
                } | {
                    blockHash: `0x${string}` | null;
                    blockNumber: bigint | null;
                    from: import("viem").Address;
    ...
    readonly mode: import("./internal/types.js").Assign<Mode.Mode, {
        ...
        readonly name: "rpc";
    }> | import("./internal/types.js").Assign<Mode.Mode, {
        readonly actions: {
...
export type Store<chains extends readonly [Chains.Chain, ...Chains.Chain[]] = readonly [
    Chains.Chain,
    ...Chains.Chain[]
]> = Mutate<StoreApi<State<chains>>, [
